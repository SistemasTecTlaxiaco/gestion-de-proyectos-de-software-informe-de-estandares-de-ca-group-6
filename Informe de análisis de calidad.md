...
Identificar las principales características técnicas de Stellar y Drips relacionadas con la calidad del software.
Analizar la importancia del código abierto, las pruebas, la documentación, la seguridad y la trazabilidad dentro de estas tecnologías.
Adaptar las métricas y prácticas de calidad de Open Hub Tec al posible uso de tecnologías Web3.
Identificar riesgos técnicos, de seguridad, privacidad y transparencia relacionados con blockchain.
Relacionar la ingeniería de software con los mecanismos de financiamiento Web3, particularmente el financiamiento on-chain y el streaming de fondos.
Aplicar el análisis a las historias de usuario HU01, HU02, HU03 y HU04 del proyecto Open Hub Tec.
...
auditoría antes de un despliegue crítico.
...
CMMI Institute. (s. f.). CMMI Development. CMMI Development

Normalización y Certificación NYCE. (s. f.). Inspección de proceso de desarrollo de software – NMX-I-059/02-NYCE-2016 (MoProSoft). MoProSoft – NYCE

Stellar Development Foundation. (s. f.). Grants and Funding. Stellar Grants and Funding

Stellar Development Foundation. (s. f.). Soroban Security Audit Bank. Soroban Security Audit Bank

Stellar Development Foundation. (2026). Stellar SCF 7.0: Grants & Funding Tracks for Web3 Builders. Stellar SCF 7.0

Stellar Development Foundation. (s. f.). Build Awards. Stellar Community Fund – Build Awards
